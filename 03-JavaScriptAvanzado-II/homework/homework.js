...
function counter() {
 ...
 // var newCounter = counter() se podria usar en consola para visualizar el contador.
...
function cacheFunction(cb) {
  ...
  invocar a cb con ese argumento; hecho eso, debe guardar el argumento junto con el resultado 
  de la invocación (tip: usá un objeto donde cada propiedad sea el argumento, y su valor el resultado
...
/*
  ...
  Las funciones obtenidas deberían recibir solamente un argumento - la cadena de texto - ya que 
